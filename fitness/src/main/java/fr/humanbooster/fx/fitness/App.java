package fr.humanbooster.fx.fitness;
...
import fr.humanbooster.fx.fitness.builder.impl.CourseBuilderImpl;
...
import fr.humanbooster.fx.fitness.util.ComparateurDAdherentsSurDistanceTotalParcourue;
...
public class App 
{
	...
	private static void ajouterTapis() {
		Tapis tapis0 = Tapis.builder().nom("STAR TRACK #0").build();
		Tapis tapis1 = Tapis.builder().nom("STAR TRAC #2").build();
		Tapis tapis2 = Tapis.builder().nom("STAR TRAC #3").build();
		lesTapis.add(tapis0);
		lesTapis.add(tapis1);
		lesTapis.add(tapis2);
	}
